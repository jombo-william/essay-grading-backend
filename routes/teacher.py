...
#     if not submissions:
#         raise HTTPException(status_code=404, detail="No AI-graded submissions found to approve.")

#     approved = 0
#     for s in submissions:
#         ai_detection = s.ai_detection_score or 0
#         # Auto-zero if high AI content, otherwise use ai_score
#         final = 0 if ai_detection >= 50 else s.ai_score
...
#     print(f"✅ Teacher {user.id} bulk-approved {approved} submission(s)")

#     return {
#         "success": True,
#         "message": f"{approved} submission(s) approved and scores released to students.",
#         "approved": approved,
#     }
